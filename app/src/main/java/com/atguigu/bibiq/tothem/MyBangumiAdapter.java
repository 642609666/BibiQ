 ...
 * 功能:追番页面适配器 番剧
 */
public class MyBangumiAdapter extends BaseAdapter {
    private final Context mContext;
    private final List<ToThemBean.ResultBean.PreviousBean.ListBean> datas;

    public MyBangumiAdapter(Context context, List<ToThemBean.ResultBean.PreviousBean.ListBean> dataBean) {
