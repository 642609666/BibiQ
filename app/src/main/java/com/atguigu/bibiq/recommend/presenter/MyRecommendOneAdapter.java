 ...
 * 功能:
 */
public class MyRecommendOneAdapter extends BaseAdapter {
    private final Context mContext;
    private final List<RecommendBean.DataBean> datas;

    public MyRecommendOneAdapter(Context context, List<RecommendBean.DataBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (online >= 10000) {
            ...
            viewHolder.tvRecommNumber.setText(online + "人追看");
        }
        //图片
        Glide.with(mContext)
